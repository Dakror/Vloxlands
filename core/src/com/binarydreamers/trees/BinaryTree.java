...
public class BinaryTree<V extends Comparable<V>> implements SortedSet<V>
{
	...
	public static class SubIntervalTree<T extends Comparable<T>> implements SortedSet<T>
	{
		...
		private SubIntervalTree(BinaryTree<T> tree, T fromElement, boolean fromInclusive, T toElement, boolean toInclusive)
		{
	...
	protected void verifyOrder()
	{
		...
		for (V node : this)
		{
			...
			{
				throw new IllegalStateException("Order is off; last:" + last + " now:" + node);
			}
		}
	}
