...
/**
 * Derived from com.badlogic.gdx.graphics.g3d.shaders.DepthShader to support transparent textures
 *
 * @author Dakror
 */
public class DepthShader extends DefaultShader
{
	...
	{
		if (defaultVertexShader == null) defaultVertexShader = Gdx.files.classpath("shader/depth.vs").readString();
	...
	{
		if (defaultFragmentShader == null) defaultFragmentShader = Gdx.files.classpath("shader/depth.fs").readString();
		return defaultFragmentShader;
	}

	public static String createPrefix(final Renderable renderable, final com.badlogic.gdx.graphics.g3d.shaders.DepthShader.Config config)
	{
		String prefix = "";
	...
	public DepthShader(final Renderable renderable, final com.badlogic.gdx.graphics.g3d.shaders.DepthShader.Config config)
	{
		this(renderable, config, createPrefix(renderable, config));
	}

	public DepthShader(final Renderable renderable, final com.badlogic.gdx.graphics.g3d.shaders.DepthShader.Config config, final String prefix)
	{
	...
	public DepthShader(final Renderable renderable, final com.badlogic.gdx.graphics.g3d.shaders.DepthShader.Config config, final String prefix, final String vertexShader, final String fragmentShader)
	{
		this(renderable, config, new ShaderProgram(prefix + vertexShader, prefix + fragmentShader));
	}

	public DepthShader(final Renderable renderable, final com.badlogic.gdx.graphics.g3d.shaders.DepthShader.Config config, final ShaderProgram shaderProgram)
	{
		super(renderable, config, shaderProgram);
		numBones = renderable.bones == null ? 0 : config.numBones;
		int w = 0;
		final int n = renderable.mesh.getVertexAttributes().size();
		for (int i = 0; i < n; i++)
		{
